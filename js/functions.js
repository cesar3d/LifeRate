...
(function($){
	...
	SEMICOLON.initialize = {
		...
		pageTransition: function(){
			...
			if( !loaderStyleHtml ) { loaderStyleHtml = '<div class="css3-spinner-rect1"></div><div class="css3-spinner-rect2"></div><div class="css3-spinner-rect3"></div><div class="css3-spinner-rect4"></div><div class="css3-spinner-rect5"></div>'; }
	...
	SEMICOLON.widget = {
		...
		notifications: function( element ){
			...
			if( !notifyMsg ) { notifyMsg = 'Correo enviado satisfactoriamente!!!'; }
						...
						$(form).ajaxSubmit({
							...
							success: function( data ) {
								...
								if( elementAlert == 'inline' ) {
									...
									elementResult.addClass( 'alert ' + alertType ).html( data.message ).slideDown( 600 );
								} else {
